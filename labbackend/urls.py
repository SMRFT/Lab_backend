...
router.register(r'clinical-names', views.ClinicalNameViewSet)
urlpatterns = [
    ...
    path('patients/filter-by-payment/', views.filter_by_payment_method, name='filter-by-payment'),
    path('patient/update_billing/<str:patient_id>/', views.update_billing, name='update_billing'),
    path('patient/tests/<str:patient_id>/', views.get_patient_tests, name='get_patient_tests'),
    ...
    path('mou-preview/<str:file_id>/', views.preview_mou_file, name='preview_mou_document'),
